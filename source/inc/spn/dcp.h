...
#define SPN_DCP_SUB_OPT_DEVICE_PROPERTIES_NAME_OF_VENDOR 0x01 /* R +F */
...
#define SPN_DCP_SUB_OPT_DEVICE_PROPERTIES_NAME_OF_ALIAS 0x06 /* NOTE: Used as filter only +F */
