...
const uint16_t supported_options[] = {
    ...
    BLOCK_TYPE(DCP_OPTION_DEV_PROP, DCP_SUB_OPT_DEV_PROP_RSI),
#endif
    BLOCK_TYPE(DCP_OPTION_CONTROL, DCP_SUB_OPT_CTR_START),
    BLOCK_TYPE(DCP_OPTION_CONTROL, DCP_SUB_OPT_CTR_STOP),
    BLOCK_TYPE(DCP_OPTION_CONTROL, DCP_SUB_OPT_CTR_SIGNAL),
    BLOCK_TYPE(DCP_OPTION_CONTROL, DCP_SUB_OPT_CTR_RESPONSE),
