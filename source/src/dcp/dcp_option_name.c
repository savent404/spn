...
const char* dcp_option_name(uint8_t option, uint8_t sub_option)
{
    ...
    case BLOCK_TYPE(DCP_OPTION_DHCP, DCP_SUB_OPT_DHCP_UNKNOW):
        return "DHCP_UNKNOW";
    case BLOCK_TYPE(DCP_OPTION_CONTROL, DCP_SUB_OPT_CTR_START):
        return "CTR_START";
    case BLOCK_TYPE(DCP_OPTION_CONTROL, DCP_SUB_OPT_CTR_STOP):
        return "CTR_STOP";
    case BLOCK_TYPE(DCP_OPTION_CONTROL, DCP_SUB_OPT_CTR_SIGNAL):
        return "CTR_SIGNAL";
    case BLOCK_TYPE(DCP_OPTION_CONTROL, DCP_SUB_OPT_CTR_RESPONSE):
        return "CTR_RESPONSE";
